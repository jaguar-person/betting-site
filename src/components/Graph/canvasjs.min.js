...
(function () {
  ...
  x = Pa.Chart = (function () {
                ...
                ? ((e = c.x1),
                  ...
                  0 > v
                    ? ((q =
                      ...
                      q < e &&
                        ((q =
                          "auto" === z ? Math.max(m.point.x, e) + l : e + l),
                        (x = q + B > m.point.x)))
                    : ((q =
            ...
            for (r = !1; q < p.length; q++)
              if (
                ...
                if ("number" !== typeof p[q].y)
                  ...
                  q < p.length - 1 &&
                    (D !== (p[q].lineColor || C) ||
                      A !== (p[q].lineDashType || m.lineDashType)) &&
                    ((D = p[q].lineColor || C),
            ...
            for (var Y = !0, q = 0; q < m.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  q < v.length - 1 &&
                    (Q !== (v[q].lineColor || x) ||
                      z !== (v[q].lineDashType || A.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, r),
                    k.push({ x: g, y: n - ma }),
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((z = v[q].lineDashType),
                          b.setLineDash(N(z, A.lineThickness)))
                  ...
                  0 <= A.dataPointIndexes[f] &&
                    ...
                    ((ma = A.getMarkerProperties(
                      A.dataPointIndexes[f],
                      g,
                      r,
                      b
                    )),
            ...
            for (var Y = !0, q = 0; q < m.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  q < x.length - 1 &&
                    (Q !== (x[q].lineColor || E) ||
                      u !== (x[q].lineDashType || A.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, r),
                    k.push({ x: g, y: y - ba }),
            ...
            for (var Q = !0; g < p.length; g++)
              if (
                ...
                if (
                  ...
                  g < p.length - 1 &&
                    (D !== (p[g].lineColor || v) ||
                      A !== (p[g].lineDashType || m.lineDashType)) &&
                    (d(),
                    (D = p[g].lineColor || v),
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !m[p - 1].lineDashType) &&
                        ((s[s.length - 1].newLineDashArray = A),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          if (-1 !== H) {
            ...
            for (G = 0; G < O.length; G++)
              (A = O[G]), pa(R, A, u.fillOpacity), ha.push(A.y1);
            v(R);
            J &&
              u.visible &&
      ...
      if ("normal" === e) {
        for (
          ...
          if (c && 0 < c.length)
            ...
            x.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          P.push(x);
          if (b && 0 < b.length)
    ...
    E.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      h = Math.pow(
        this.logarithmBase,
        E.getNiceNumber(Math.abs(Math.log(h) / d), !1)
      );
      this.options && 0 < this.options.interval
